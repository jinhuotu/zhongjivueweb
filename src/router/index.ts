...
const MIGRATED_VIEWS: Record<string, () => Promise<{ default: Component }>> = {
  ...
  '/casting-peel': () => import('@/views/CastingPeelView.vue'),
  '/casting-qa-month': () => import('@/views/CastingQaMonthView.vue'),
  ...
  '/quality/procurement': () => import('@/views/quality/QualityProcurementView.vue'),
