  ...
  <div v-else class="space-y-5">
    <header class="flex flex-wrap items-end justify-between gap-3">
      ...
      <div class="flex gap-2">
        <button
          type="button"
          class="inline-flex items-center gap-1.5 h-8 px-3 rounded-md text-[12px] bg-iron text-[#0b0f14] hover:bg-[#ff7d4e]"
    ...
    >
      ...
      <template #footer>
        <button
          type="button"
          class="px-3 py-1.5 text-[12px] rounded-md text-text-secondary hover:bg-hairline/40"
          :disabled="saving"
